...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\AutoPartsWarehouse\\InfrastructureAutoPartsWarehouse\\ApiAutoPartsWarehouse\\ControllerAutoPartsWarehouse\\AutoPartsWarehouseController' => 'getAutoPartsWarehouseControllerService',
            'App\\Controller\\MainController' => 'getMainControllerService',
            'App\\Counterparty\\InfrastructureCounterparty\\ApiCounterparty\\ControllerCounterparty\\CounterpartyController' => 'getCounterpartyControllerService',
            'App\\PartNumbers\\InfrastructurePartNumbers\\ApiPartNumbers\\ControllerPartNumbers\\PartNumbersController' => 'getPartNumbersControllerService',
            'App\\PartNumbers\\InfrastructurePartNumbers\\ErrorMessageViaSession\\ErrorMessageViaSession' => 'getErrorMessageViaSessionService',
            'App\\Sales\\InfrastructureSales\\ApiSales\\ControllerSales\\SalesController' => 'getSalesControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('LuAv8pQCYe', 0, ($container->targetDir.''.'/pools/app'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('858OCmE5L8', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bccsZj9nKy', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uYiPz0fBTy', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $b->addDriver(($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).'/src')], true)), 'App');
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\AutoPartsWarehouse\\InfrastructureAutoPartsWarehouse\\RepositoryAutoPartsWarehouse\\AutoPartsWarehouseRepository' => ['privates', 'App\\AutoPartsWarehouse\\InfrastructureAutoPartsWarehouse\\RepositoryAutoPartsWarehouse\\AutoPartsWarehouseRepository', 'getAutoPartsWarehouseRepositoryService', true],
            'App\\AutoPartsWarehouse\\InfrastructureAutoPartsWarehouse\\RepositoryAutoPartsWarehouse\\PaymentMethodRepository' => ['privates', 'App\\AutoPartsWarehouse\\InfrastructureAutoPartsWarehouse\\RepositoryAutoPartsWarehouse\\PaymentMethodRepository', 'getPaymentMethodRepositoryService', true],
            'App\\Counterparty\\InfrastructureCounterparty\\RepositoryCounterparty\\CounterpartyRepository' => ['privates', 'App\\Counterparty\\InfrastructureCounterparty\\RepositoryCounterparty\\CounterpartyRepository', 'getCounterpartyRepositoryService', true],
            'App\\PartNumbers\\InfrastructurePartNumbers\\RepositoryPartNumbers\\AvailabilityRepository' => ['privates', 'App\\PartNumbers\\InfrastructurePartNumbers\\RepositoryPartNumbers\\AvailabilityRepository', 'getAvailabilityRepositoryService', true],
            'App\\PartNumbers\\InfrastructurePartNumbers\\RepositoryPartNumbers\\AxlesRepository' => ['privates', 'App\\PartNumbers\\InfrastructurePartNumbers\\RepositoryPartNumbers\\AxlesRepository', 'getAxlesRepositoryService', true],
            'App\\PartNumbers\\InfrastructurePartNumbers\\RepositoryPartNumbers\\BodiesRepository' => ['privates', 'App\\PartNumbers\\InfrastructurePartNumbers\\RepositoryPartNumbers\\BodiesRepository', 'getBodiesRepositoryService', true],
            'App\\PartNumbers\\InfrastructurePartNumbers\\RepositoryPartNumbers\\CarBrandsRepository' => ['privates', 'App\\PartNumbers\\InfrastructurePartNumbers\\RepositoryPartNumbers\\CarBrandsRepository', 'getCarBrandsRepositoryService', true],
            'App\\PartNumbers\\InfrastructurePartNumbers\\RepositoryPartNumbers\\OriginalRoomsRepository' => ['privates', 'App\\PartNumbers\\InfrastructurePartNumbers\\RepositoryPartNumbers\\OriginalRoomsRepository', 'getOriginalRoomsRepositoryService', true],
            'App\\PartNumbers\\InfrastructurePartNumbers\\RepositoryPartNumbers\\PartNameRepository' => ['privates', 'App\\PartNumbers\\InfrastructurePartNumbers\\RepositoryPartNumbers\\PartNameRepository', 'getPartNameRepositoryService', true],
            'App\\PartNumbers\\InfrastructurePartNumbers\\RepositoryPartNumbers\\PartNumbersFromManufacturersRepository' => ['privates', 'App\\PartNumbers\\InfrastructurePartNumbers\\RepositoryPartNumbers\\PartNumbersFromManufacturersRepository', 'getPartNumbersFromManufacturersRepositoryService', true],
            'App\\PartNumbers\\InfrastructurePartNumbers\\RepositoryPartNumbers\\SidesRepository' => ['privates', 'App\\PartNumbers\\InfrastructurePartNumbers\\RepositoryPartNumbers\\SidesRepository', 'getSidesRepositoryService', true],
            'App\\Sales\\InfrastructureSales\\RepositorySales\\AutoPartsSoldRepository' => ['privates', 'App\\Sales\\InfrastructureSales\\RepositorySales\\AutoPartsSoldRepository', 'getAutoPartsSoldRepositoryService', true],
        ], [
            'App\\AutoPartsWarehouse\\InfrastructureAutoPartsWarehouse\\RepositoryAutoPartsWarehouse\\AutoPartsWarehouseRepository' => '?',
            'App\\AutoPartsWarehouse\\InfrastructureAutoPartsWarehouse\\RepositoryAutoPartsWarehouse\\PaymentMethodRepository' => '?',
            'App\\Counterparty\\InfrastructureCounterparty\\RepositoryCounterparty\\CounterpartyRepository' => '?',
            'App\\PartNumbers\\InfrastructurePartNumbers\\RepositoryPartNumbers\\AvailabilityRepository' => '?',
            'App\\PartNumbers\\InfrastructurePartNumbers\\RepositoryPartNumbers\\AxlesRepository' => '?',
            'App\\PartNumbers\\InfrastructurePartNumbers\\RepositoryPartNumbers\\BodiesRepository' => '?',
            'App\\PartNumbers\\InfrastructurePartNumbers\\RepositoryPartNumbers\\CarBrandsRepository' => '?',
            'App\\PartNumbers\\InfrastructurePartNumbers\\RepositoryPartNumbers\\OriginalRoomsRepository' => '?',
            'App\\PartNumbers\\InfrastructurePartNumbers\\RepositoryPartNumbers\\PartNameRepository' => '?',
            'App\\PartNumbers\\InfrastructurePartNumbers\\RepositoryPartNumbers\\PartNumbersFromManufacturersRepository' => '?',
            'App\\PartNumbers\\InfrastructurePartNumbers\\RepositoryPartNumbers\\SidesRepository' => '?',
            'App\\Sales\\InfrastructureSales\\RepositorySales\\AutoPartsSoldRepository' => '?',
        ])));
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\AutoPartsWarehouse\\InfrastructureAutoPartsWarehouse\\ApiAutoPartsWarehouse\\ControllerAutoPartsWarehouse\\AutoPartsWarehouseController', 'App\\Controller\\MainController', 'App\\Counterparty\\InfrastructureCounterparty\\ApiCounterparty\\ControllerCounterparty\\CounterpartyController', 'App\\PartNumbers\\InfrastructurePartNumbers\\ApiPartNumbers\\ControllerPartNumbers\\PartNumbersController', 'App\\PartNumbers\\InfrastructurePartNumbers\\ErrorMessageViaSession\\ErrorMessageViaSession', 'App\\Sales\\InfrastructureSales\\ApiSales\\ControllerSales\\SalesController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('d1r-ZqWbcx', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('IJ8J10xtQu', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('z74AzGDfgU', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))));
    }
    ...
    protected static function getTwigService($container)
    {
        ...
        $a->addPath('src/Counterparty/InfrastructureCounterparty/ApiCounterparty/templatesCounterparty', 'counterparty');
        $a->addPath('src/PartNumbers/InfrastructurePartNumbers/ApiPartNumbers/templatesPartNumbers', 'partNumbers');
        $a->addPath('src/AutoPartsWarehouse/InfrastructureAutoPartsWarehouse/ApiAutoPartsWarehouse/templatesAutoPartsWarehouse', 'autoPartsWarehouse');
        $a->addPath('src/Sales/InfrastructureSales/ApiSales/templatesSales', 'sales');
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'secit.imap.connections' => [
                'example' => [
                    'imap_path' => '{imap.mail.ru:993/imap/ssl/novalidate-cert}INBOX',
                    'username' => 'imap_test_test_test@mail.ru',
                    'password' => 'jVRBymTQUhzvExwcka67',
